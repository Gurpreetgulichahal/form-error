...
baseUrl!:any;
  ...
  //         this.httpClient.get<any>(this.baseUrl+'/getformsbasedonsection/myForms').subscribe(
  //           response => {
  //             this.forms = response;
  //           }
  //         );       
  ...
  getBodyClass(): string {
   ...
   getForms() {
    ...
    var url = this.baseUrl+'/getmyforms/'+ this.name;
...
openForm(form: Forms){
  ...
  this.router.navigate(['editPage'],{ queryParams: { id:this.openId}});
